        ...
        <div>
            <div className="md:flex justify-between items-center py-14 space-y-10">
                <div className="space-y-5">
                    <h1 className=" text-3xl md:text-3xl 2xl:text-5xl leading-7">We explore your ability <br className='hidden md:flex'/> and employment <br className='hidden md:flex'/>solutions</h1>
                    ...
                    <button className="bg-[#725ad9] hover:bg-[#644dca] py-2 px-6 rounded"><p className="text-sm md:text-base">Book Now</p></button>
                </div>
                <div className="image">
